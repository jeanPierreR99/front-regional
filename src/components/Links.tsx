  ...
  return (
    ...
    >
      <a
        ...
        className="w-[170px] bg-none text-gray-200 border border-[#3183a9] hover:bg-[#3183a9]/20 hover:text-white transition-all duration-300 items-center justify-center h-[150px] flex flex-col gap-2 shadow-lg p-8 rounded-lg hover:scale-125"
      >
