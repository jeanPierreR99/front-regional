...
const CardOption: React.FC = () => {
  ...
  return (
    <div className="flex flex-wrap gap-10 justify-center py-20 md:pt-0 items-center w-full h-full  md:h-[calc(100vh-84px)] overflow-hidden">
      <button
        onClick={() => {
          handleChangeParam("estadistica", setParamURL, setParamId);
        }}
        className="w-[200px] bg-white text-blue-700 hover:bg-blue-700 hover:text-white font-bold transition-all duration-300 items-center justify-center h-[200px] flex flex-col gap-2 shadow-lg p-8 rounded-lg hover:scale-125"
      >
